...
namespace IVMElectro.ViewModel.Premag {
    public class StringOfVarParamsAxisVM : INotifyPropertyChanged, IDataErrorInfo {
        ...
        #region properties
        public StringOfVarParametersAxis Model { get; private set; }
        public string ID_culc { get => Model.ID_culc.ToString(); set { Model.ID_culc = StringToInt(value); } }
