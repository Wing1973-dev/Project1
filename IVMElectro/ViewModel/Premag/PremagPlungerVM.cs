    ...
    public class PremagPlungerVM : INotifyPropertyChanged, IDataErrorInfo {
        ...
        void ViewResult() {
            if (resultCalculation != null) {
                ...
                WriteParamToResultFile("Фδ", "Ф<sub>δ</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bδ", "B<sub>δ</sub>,&nbsp;Тл");
                WriteParamToResultFile("Fδ", "F<sub>δ</sub>,&nbsp;А");
                WriteParamToResultFile("Фp", "Ф<sub>p</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bp1", "B<sub>p1</sub>,&nbsp;Тлс");
                WriteParamToResultFile("Bp11", "B<sub>p11</sub>,&nbsp;Тл");
                WriteParamToResultFile("Bp12", "B<sub>p12</sub>,&nbsp;Тл");
                WriteParamToResultFile("Fp", "F<sub>p</sub>,&nbsp;А");
                WriteParamToResultFile("Фк", "Ф<sub>к</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bк", "B<sub>к</sub>,&nbsp;Тл");
                WriteParamToResultFile("Fк", "F<sub>к</sub>,&nbsp;А");
                WriteParamToResultFile("Fфл", "F<sub>фл</sub>,&nbsp;А");
                WriteParamToResultFile("Фпз", "Ф<sub>пз</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bпз", "B<sub>пз</sub>,&nbsp;Тл");
