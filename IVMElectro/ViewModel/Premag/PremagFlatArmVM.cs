    ...
    public class PremagFlatArmVM : INotifyPropertyChanged, IDataErrorInfo {
        ...
        void ViewResult() {
            if (resultCalculation != null || resultCalculation.Count > 0) {
                ...
                WriteParamToResultFile("Фяр", "Ф<sub>яр</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bяр", "B<sub>яр</sub>,&nbsp;Тл");
                WriteParamToResultFile("Fяр", "F<sub>яр</sub>,&nbsp;А");
                WriteParamToResultFile("Фяк", "Ф<sub>яр</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bяк", "B<sub>як</sub>,&nbsp;Тл");
                WriteParamToResultFile("Fяк", "F<sub>як</sub>,&nbsp;А");
                WriteParamToResultFile("Фp", "Ф<sub>p</sub>,&nbsp;Вб");
                WriteParamToResultFile("Bp1", "B<sub>p1</sub>,&nbsp;Тл");
                WriteParamToResultFile("Bp2", "B<sub>p2</sub>,&nbsp;Тл");
