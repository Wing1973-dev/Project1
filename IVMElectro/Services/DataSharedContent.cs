...
namespace IVMElectro.Services {
    static class DataSharedContent {
        #region string error
        public const string errorP12 = "Значение параметра Pʹ2 должено принадлежать [50 : 200000].";
        public const string errorU1 = "Значение параметра U1 должено принадлежать [48 : 660].";
        public const string errorf1 = "Значение параметра f1 должено принадлежать [10 : 400].";
        public const string errorDi = "Значение параметра Di должено принадлежать (50 : 1100].";
        public const string errorΔГ1 = "Значение параметра ΔГ1 должено принадлежать [0 : 10].";
        public const string errorZ1 = "Ошибочное значение параметра Z1.";
        public const string errora1 = "Ошибочное значение параметра a1.";
        public const string errora2 = "Значение параметра a2 должено принадлежать [0 : 30].";
        ...
        public const string errorbz1 = "Значение параметра bz1 должено принадлежать [3,5 : 15].";
        public const string errorh8 = "Значение параметра h8 должено принадлежать [0 : 20].";
        public const string errorh7 = "Значение параметра h7 должено принадлежать [0 : 2].";
        public const string errorh6 = "Значение параметра h6 должено принадлежать [0 : 20].";
        ...
        public const string errorli = "Значение параметра li должено принадлежать [0,5 : 3].";
        public const string errorcз = "Значение параметра cз должено принадлежать [0 : 200].";
        public const string errorbП = "Ошибочное значение параметра bП.";
        public const string errorKзап = "Значение параметра Kзап должено принадлежать [0,36 : 0,76].";
        public const string errorβ = "Значение параметра β должено принадлежать [0,5 : 0,95].";
        public const string errorK2 = "Ошибочное значение параметра K2.";
        public const string errorKfe1 = "Значение параметра Kfe должено принадлежать [0,9 : 1].";
        public const string errorρ1x = "Значение параметра ρ1x должено принадлежать [0,002 : 0.05].";
        public const string errorρРУБ = "Ошибочное значение параметра ρРУБ.";
        public const string errorB = "Значение параметра B должено принадлежать [0 : 20].";
        public const string errorp10_50 = "Ошибочное значение параметра p10_50.";
        public const string errorΔГ2 = "Значение параметра ΔГ2 должено принадлежать [0 : 5].";
        public const string errorbП2 = "Значение параметра bП2 должено принадлежать [2 : 6].";
        ...
        #endregion
        public static double bП1Calc(double Di, double h8, double h7, double h6, double bz1, double Z1) => (Math.PI * (Di + 2 * (h8 + h7 + h6)) - bz1) / Z1;
        ...
        public static List<string> Z1Collection(double Di, int p) {
            int start = Convert.ToInt32(Math.Round(Math.PI * Di / 120 / Convert.ToDouble(p))),
                end = Convert.ToInt32(2 * Math.Round(Math.PI * Di / 120 / Convert.ToDouble(p)));
        ...
        public static List<string> a1Collection(int p, int Z1) {
            ...
            for (int i = 2; i < p; i++) {
                ...
                if (add >= 1 && add <= p) sequence.Add(add.ToString());
            }
        ...
        public static string Get_liBounds(double U1, double I1, double Di) 
            => $"[{3 * U1 * I1 * 30 * 1e3 / 0.75 / 4e4 / Math.PI / Di} : " +
            $"{3 * U1 * I1 * 30 * 1e3 / 0.5 / 1.5e3 / Math.PI / Di}]"; //label
        ...
        public static (double left, double right) Get_DaBounds(double Di) => (left: 1.4 * Di, right: 2 * Di);
